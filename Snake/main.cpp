...
int main()
{
    ...
    Texture t;
    t.loadFromFile("C:/Users/andry/source/repos/Snake/Snake/img/tiles.png");
    Sprite tiles(t);

    Texture sn;
    sn.loadFromFile("C:/Users/andry/source/repos/Snake/Snake/img/snake.png");
    Sprite snake(sn);

    Texture ap;
    ap.loadFromFile("C:/Users/andry/source/repos/Snake/Snake/img/apple.png");
    Sprite apple(ap);

    Texture go;
    go.loadFromFile("C:/Users/andry/source/repos/Snake/Snake/img/gameover.png");
    Sprite gameover(go);
